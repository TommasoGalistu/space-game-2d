...
function animate() {
  ...
  if (player.position.x + player.width >= obstacle.position.x && player.position.y + player.height >= obstacle.position.y) {
    player.velocity.x = 0;
  }
  ...
  if (scrollOffset > 7640) {
    var _console;
    /* eslint-disable */(_console = console).log.apply(_console, _toConsumableArray(oo_oo("4136508843_261_8_261_30_4", 'you win')));
  }
