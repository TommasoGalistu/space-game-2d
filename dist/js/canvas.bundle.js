...
function animate() {
  ...
  if (player.position.y + player.height + player.velocity.y <= canvas.height) {
    ...
    var _console;
    /* eslint-disable */(_console = console).log.apply(_console, _toConsumableArray(oo_oo("96835553_152_4_152_23_4", 'lose')));
  }
  // player with platform comporment
  platforms.forEach(function (platform) {
    var _console2;
    /* eslint-disable */(_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("96835553_157_4_157_91_4", player.position.y + player.height + player.velocity.y, platform.position.y)));
