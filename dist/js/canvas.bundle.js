...
/* eslint-disable */
(_console = console).log.apply(_console, _toConsumableArray(oo_oo("857532806_12_0_12_21_4", 'dentro')));
...
var platforms = [new Platform({
  ...
  x: platformImage.width * 6 + 350,
  y: 480,
  image: platformImage
}), new Platform({
  x: platformImage.width * 7 + 350,
  y: 350,
  image: platformImage
})];
...
function animate() {
  ...
  if (scrollOffset > 2000) {
    var _console2;
    /* eslint-disable */(_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("857532806_224_8_224_30_4", 'you win')));
  }
...
addEventListener('keydown', function (_ref3) {
  ...
  /* eslint-disable */(_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("857532806_243_3_243_23_4", keyCode)));
  switch (keyCode) {
    case 82:
      // left a
...
addEventListener('keyup', function (_ref4) {
  ...
  /* eslint-disable */(_console4 = console).log.apply(_console4, _toConsumableArray(oo_oo("857532806_272_4_272_24_4", keyCode)));
  switch (keyCode) {
    case 82:
      // left a
