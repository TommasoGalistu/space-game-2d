...
var obstacles = [new Obstacle({
  x: 500,
  y: 350,
  image: createImage(_img_obstacle_png__WEBPACK_IMPORTED_MODULE_3__["default"])
})
...
function animate() {
  ...
  if (scrollOffset > 7640) {
    var _console;
    /* eslint-disable */(_console = console).log.apply(_console, _toConsumableArray(oo_oo("980727260_303_8_303_30_4", 'you win')));
  }
